    ...
    <div class="row">
        <div class="col-md-6">
            <div class="col-md-12 pt-5">
                <h1 class="txt1">High School Scholarship Application (2023-2024)</h1>
                <div class="col-md-12">
                    <p class="txt2">
                        The information provided on this form will be used by the High
                        School Scholarship Committee to select recipients for scholarships.
                        It is important that you give complete details concerning your
                        college/career plans, activities and financial information.
                    </p>
                </div>
            </div>
            ...
            <div class="row pt-4">
                <div class="col-md-12">
                    <h3 class="txt1">1.Basic Informations</h3>
                </div>
            </div>

            <div class="row pt-3" style="color: white">
                <h5>
                    Student Full Name / Legal Name
            ...
            <div class="row pt-1" style="color: white">
                <h5>
                    Student ID: <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
                    <input v-model="v$.form.studentid.$model" class="px-4 input-field" placeholder="EX:1275432" type="text" />
                </div>

                <div class="input-errors" v-for="(error, index) of v$.form.studentid.$errors" :key="index">
                    <div class="error-msg" style="color: red; text-align: left; font-size: 16px">
                        {{ error.$message }}
                        <i class="fa fa-info " title="Student ID can only contain multiple numbers (0-9)." style="text-align: right">
                        </i>
                    </div>
                </div>
            </div>
            ...
            <div class="row pt-3" style="color: white">
                <h5>
                    Student Address <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
...
<div class="container h-100 d-none " id="secondCont">
    <div class="row ">
        <div class="col-md-6">
            ...
            <div class="row pt-3" style="color: white">
                <h5>
                    Student Phone Number <span style="color: red"><sup>*</sup></span>
                </h5>
            ...
            <div class="row pt-3" style="color: white">
                <h5>
                    Student E-Mail: <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
            ...
            <div class="row" style="color: white">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="radio" v-model="form.gender" name="gender" value="notprefer" /> Not prefer to say
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container h-100 d-none" id="thirdCont">
    <div class="row">
        <div class="col-md-6">
            <div class="row pt-4">
                <div class="col-md-12">
                    <h3 class="txt1">2.ACT Information</h3>
                </div>
            </div>

            <div class="row" style="color: white">
                <h5>Do you have ACT Result</h5>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="radio" v-model="form.actmodel" name="act" value="actyes" /> Yes
                        </div>

                        <div class="col-md-6">
                            <input type="radio" v-model="form.actmodel" name="act" value="actno" /> No
                        </div>
                    </div>
                    <div class="pt-2">
                        <p>
                            If <span style="color: red">NO</span> don't fill the ahead details
                            of ACT Informations.
                        </p>
                    </div>
                </div>
            ...
            <div class="row pt-3" style="color: white">
                <h5>
                    Year you took the ACT <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
                    <input type="month" id="start" name="start" v-model="form.yearact" min="1999-01" max="2021-12"  class="px-4 input-field" placeholder="YYYY Format" />
                    <p>Add month as-well</p>
                </div>
            </div>
            ...
            <div class="row pt-3" style="color: white">
                ...
                <div class="col-md-12">
                    <input class="px-4 input-field" v-model="form.scoreact" placeholder="In Percentage (%)" type="text" />
                </div>
            </div>
            ...
            <div class="row pt-3" style="color: white">
                <div class="col-md-12">
                    <p class="p1">
                        ACT scores are not required for scholarship eligibility. However,
                        providing an ACT score can increase the likelihood of your selection
                        as compared to other candidates.
                    </p>

                    <p class="p1">
                        All scholarship applicants reporting an ACT score will be asked to
                        provide official verification.
                    </p>
                </div>
            </div>
            ...
            <div class="row " style="color: white">
                <div class="col-md-6 text-center ">
                    <button class="p-2 px-4 btn1" @click="firststep()">Back</button>
                </div>

                <div class="col-md-6 text-center">
                    <button class="p-2 px-4 btn1" @click="fourthstep()">Next</button>
                </div>
            </div>
        </div>
...
<div class="container h-100 d-none" id="fourthCont">
    <div class="row">
        <div class="col-md-6">
            <div class="row pt-4">
                <div class="col-md-12">
                    <h3 class="txt1">3.Results Certifications.</h3>
                </div>
            </div>

            <div class="row pt-3" style="color: white">
                <h5>
                    SSC EXAM MARKSHEET <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
                    <input type="file" accept="image/*,.pdf" class="px-4 input-field" />
                    <p>Share PDF Only.</p>
                </div>
            </div>
            ...
            <div class="row pt-3" style="color: white">
                <h5>
                    HSC EXAM MARKSHEET <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
                    <input type="file" accept="image/*,.pdf" class="px-4 input-field" />
                    <p>Share PDF Only.</p>
            ...
            <div class="row" style="color: white">
                <h5>Have you perfomed Competetive Exams?</h5>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="radio" name="comexam" v-model="form.comexam" value="comexamyes" /> Yes
                        </div>

                        <div class="col-md-6">
                            <input type="radio" name="comexam" v-model="form.comexam" value="comexamno" /> No
                        </div>
                    </div>
                    <div class="pt-2">
                        <p>
            ...
            <div class="row pt-3" style="color: white">
                ...
                <div class="col-md-12">
                    <select value="null" v-model="form.comexamselect" class="px-4 input-field col-md-12">
                        <option value="Select" selected>Select</option>
                        <option value="Xavier Admission Test (XAT)">
                        ...
                        <option value="Combined Defence Services Examination (CDS)">
                            Combined Defence Services Examination (CDS)
                        </option>
                        <option value="National Defence Academy Examination (NDA)">
                            National Defence Academy Examination (NDA)
                        </option>
                        <option value="Food Corporation of India Examination (FCI)">
                            Food Corporation of India Examination (FCI)
                        </option>
                        <option value="Common Entrance Examination for Design (CEED)">
                            Common Entrance Examination for Design (CEED)
                        </option>
                        <option value="National Entrance Screening Test (NEST)">
                            National Entrance Screening Test (NEST)
                        </option>
                        <option value="Symbiosis Institute of Design Exam (SEED)">
                            Symbiosis Institute of Design Exam (SEED)
                        </option>
                        <option value="ArgenCommon Entrance Examination for Design (CEED)">
                            Common Entrance Examination for Design (CEED)
                        </option>
                        <option value="National Institute of Fashion Design">
            ...
            <div class="row pt-3" style="color: white">
                <h5>
                    COMPETETIVE EXAM RESULT <span style="color: red"><sup>*</sup></span>
                </h5>
                <div class="col-md-12">
                    <input type="file" accept="image/*,.pdf" class="px-4 input-field" />
                    <p>Share PDF Only.</p>
            ...
            <div class="row pt-3" style="color: white">
                <div class="col-md-12">
                    <p class="p1">
                        Although if you have attended more than one
                        <span style="color: red">Competetive Exams</span> you have share it
                        in the ESSAY field although one is eneough.
                    </p>
                </div>
            </div>
            ...
            <div class="row  text-center " style="color: white">
                <div class="col-md-6">
                    <button class="p-2 px-4 btn1" @click="thirdstep()">Back</button>
                </div>

                <div class="col-md-6">
                    <button class="p-2 px-4 btn1" @click="fifthstep()">Next</button>
                </div>
            </div>
        </div>
...
<div class="container h-100 d-none " id="fifthCont">
    <div class="row">
        <div class="col-md-6">
            <div class="row pt-4">
                <div class="col-md-12">
            ...
            <div class="row pt-3" style="color: white">
                <div class="col-md-12">
                    ...
                    <textarea type="textarea" v-model="form.essay" placeholder="Your essay should be 300-500 words." rows="7" cols="50" style="resize: none" class="px-4 input-field"></textarea>
                </div>
            </div>
            ...
            <div class="row text-center" style="color: white">
                <div class="col-md-6">
                    <button class="p-2 px-4 btn1" @click="fourthstep()">Back</button>
                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" style="color: red;" @click="savedata() " class="btn2 px-3 p-1">
...
export default {
    ...
    methods: {
      savedata() {
            axios
                .post("http://127.0.0.1:8000/api/studentformpost", this.form)
                .then(({
                    data
                }) => {
                    console.log(data);
        ...
        thirdstep() {
            ...
            document.getElementById("fourthCont").classList.add("d-none");
        },
        fourthstep() {
            document.getElementById("thirdCont").classList.add("d-none");
            document.getElementById("fourthCont").classList.remove("d-none");
            document.getElementById("fifthCont").classList.add("d-none");
        },
        fifthstep() {
            document.getElementById("fourthCont").classList.add("d-none");
            document.getElementById("fifthCont").classList.remove("d-none");
        },
    },
};
</script>
